...
public class ChooseAreaActivity extends Activity {
    ...
    /**
     * 查询选中省内所有的市，优先从数据库中查询，如果没有查询到，再从服务器中查询
     */
    ...
    /**
     * 查询选中市内所有的县，优先从数据库中查询，如果没有查询到再从服务器中查询
     */
    ...
    private void queryFromServer(final String code, final String type) {
        String address;
        if (type.equals("province")||type.equals("county")) {
            address = "http://www.weather.com.cn/data/list3/city.xml";
        } else {
            address = "http://www.weather.com.cn/data/list3/city" + code + "01.xml";
        }
        showProgressDialog();
